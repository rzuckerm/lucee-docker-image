LUCEE_VERSION := $(shell cat LUCEE_VERSION)
LUCEE_DEPS := $(wildcard LUCEE_*) run_lucee
DOCKER_TAG_PREFIX := rzuckerm/lucee:$(LUCEE_VERSION)
...
$(META_BUILD_TARGET): Dockerfile Makefile $(LUCEE_DEPS)
